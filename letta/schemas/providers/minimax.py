...
MODEL_LIST = [
    {
        ...
        "max_output": 128000,
        "description": "Latest model. 512K context, supports image input (default).",
    },
    {
        "name": "MiniMax-M2.7",
    ...
    },
    {
        ...
        "context_window": 200000,
        "max_output": 128000,
        "description": "Previous generation low-latency model.",
    },
]
...
class MiniMaxProvider(Provider):
    ...
    async def check_api_key(self):
        ...
        try:
            ...
            await client.messages.count_tokens(model=MODEL_LIST[0]["name"], messages=[{"role": "user", "content": "a"}])
    ...
    def get_model_context_window_size(self, model_name: str) -> int | None:
        ...
        # Default fallback (M3 context window)
        return 512000
