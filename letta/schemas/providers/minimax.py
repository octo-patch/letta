...
class MiniMaxProvider(Provider):
    ...
    base_url: str = Field(MINIMAX_GLOBAL_ANTHROPIC_BASE_URL, description="Base URL for the MiniMax Anthropic-compatible API.")
        ...
        for model in MODEL_LIST:
            configs.append(
                LLMConfig(
                    ...
                    put_inner_thoughts_in_kwargs=model["thinking"] == "always_on",
                    enable_reasoner=model["thinking"] == "always_on",
